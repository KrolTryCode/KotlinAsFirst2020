...
class Tests {
    ...
    @Tag("3")
    fun lineBySegment() {
        assertApproxEquals(Line(Point(0.5441097294015061, 5e-324), 1.5707614702439976), lineBySegment(Segment(Point(0.5441097294015061, 5e-324), Point(0.5220803892245913, -632.0))))
    ...
    fun bisectorByPoints() {
        assertApproxEquals(Line(Point(0.2620102384685008, 0.0), 0.0), bisectorByPoints(Point(5e-324, 0.5240204769370018), Point(0.0, -2.220446049250313e-16)))
